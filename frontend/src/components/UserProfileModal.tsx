...
export default function UserProfileModal({ visible, onHide, currentUser, onUpdateUser }: Props) {
  ...
  // Modals for Edit and QR Code (exact same as AgendaAttendees)
    ...
    <>
      ...
      >
        <div className="relative flex flex-column align-items-center">
          ...
          <div 
            className="relative overflow-hidden w-full select-none flex flex-column justify-content-between"
            style={{ 
              maxWidth: '480px', 
              aspectRatio: '85.6 / 54',
              height: 'auto',
          ...
          >
            ...
            <div className="flex flex-column flex-1 justify-content-center m-0 p-0 min-w-0">
              ...
              <div className="flex flex-column gap-1 text-xs sm:text-sm text-white-alpha-90">
                ...
                <div>
                  <strong className="block text-3xs sm:text-xs text-white-alpha-60 uppercase tracking-wide mt-1 mb-0">Agenden</strong>
                ...
                <div>
                  ...
                  <span className="m-0 p-0 line-height-1 font-bold text-yellow-300">
                    {statsLoading ? '...' : `${stats.totalItemsContributed} Punkte`}
                  </span>
                </div>
              </div>
      ...
      {/* Exact Agenda Edit Modal */}
      <Dialog
        header="Profildaten bearbeiten"
